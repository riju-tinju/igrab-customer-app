                        ...
                        >
                            {product.images?.map((img: string, idx: number) => {
                                const imageUrl = img.startsWith('http')
                                    ? img
                                    : `http://localhost:5000/${img.startsWith('/') ? img.substring(1) : img}`;
                                return (
                                    <SwiperSlide key={idx}>
                                        <img
                                            src={imageUrl}
                                ...
                                <div className="w-14 h-14 rounded-2xl bg-gray-50 p-2 border border-gray-100 overflow-hidden flex-shrink-0 text-center flex items-center justify-center">
                                    <img
                                        src={product.brandId.logo.startsWith('http')
                                            ...
                                            : `http://localhost:5000/${product.brandId.logo.startsWith('/') ? product.brandId.logo.substring(1) : product.brandId.logo}`}
